...
class _SignUpState extends State<SignUp> {
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            ...
            if (name == null ||
                ...
                password.isEmpty) {
              print('Have Space');
              normalDialog(context, 'กรอกข้อมูลให้ครบทุกช่อง');
  ...
  Future<Null> checkUser() async {
    ...
    try {
      ...
      if (response.toString() == 'null') {
        ...
        normalDialog(context, 'user นี้ $user มีคนใช้แล้ว');
      }
    } catch (e) {}
  }
  ...
  Future<Null> registerThread() async {
    String url =
        'https://foodzaab.com/foodzaab/addUser.php?isAdd=true&Name=$name&User=$user&Password=$password&ChooseType=$chooseType';
    ...
    try {
      ...
      if (response.toString() == 'true') {
        ...
        normalDialog(context, 'ไม่สามารถสมัครสมาชิกได้ค่ะ');
      }
    } catch (e) {}
  }
